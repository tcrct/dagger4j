...
//    private static final Logger logger = LoggerFactory.getLogger(ScanFileFactory.class);
//
//    /**
...
//     * @return
//     */
//    public static List<Class<?>> scanClass(String packagePath, List<String> jarNameList) {
...
//     * @param packageName
//     */
//    private static void addClass(List<Class<?>> classList, String classAbsolutePath, String packageName) throws Exception {
...
//    }
//
//    private static void doAddClass(List<Class<?>> classList, String packageName, String fileName) throws Exception{
//        if(fileName.endsWith(".class")) {
//            // 获取类名, 移除扩展名
