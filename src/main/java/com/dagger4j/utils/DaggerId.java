 ...
 * @date  2017/11/21.
 */
 public final class DaggerId implements Comparable<DaggerId>, Serializable {


    private static final long serialVersionUID = 3670079982654483072L;

    static final Logger LOGGER = LoggerFactory.getLogger(DaggerId.class);
     ...
     * @return the new id
     */
    public static DaggerId get() {
        return new DaggerId();
    }

    /**
     * Checks if a string could be an {@code DaggerId}.
     *
     ...
     * @since 2.12.0
     */
    public static DaggerId createFromLegacyFormat(final int time, final int machine, final int inc) {
        return new DaggerId(time, machine, inc);
    }
     ...
     * @param date the date
     */
    public DaggerId(final Date date) {
     ...
     */
    public DaggerId(final Date date, final int counter) {
     ...
     */
    public DaggerId(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     */
    public DaggerId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
        this(timestamp, machineIdentifier, processIdentifier, counter, true);
    }

    private DaggerId(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter,
     ...
     */
    public DaggerId(final String hexString) {
     ...
     */
    public DaggerId(final byte[] bytes) {
        if (bytes == null) {
            throw new IllegalArgumentException();
        }
        if (bytes.length != 12) {
     ...
     */
    DaggerId(final int timestamp, final int machineAndProcessIdentifier, final int counter) {
...
//        StringBuilder buf = new StringBuilder(24);
    ...
    @Override
    public int compareTo(final DaggerId other) {
        if (other == null) {
